...
return [
    ...
    'timestamp' => 1512242207,
    'checksum' => '69565f2161776fcebbbcb8fa80ce3ee2',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'email' => [
                'enabled' => true,
                'from' => 'info@benzlim.info',
                'from_name' => NULL,
                'to' => 'info@benzlim.info',
                'to_name' => NULL,
                'mailer' => [
                    'engine' => 'sendmail',
                    'smtp' => [
        ...
        'site' => [
            'title' => 'A Fuel Prediction Software',
            'default_lang' => 'en',
            'author' => [
                'name' => 'Benzlim Group',
            ...
            'metadata' => [
                'description' => 'Benzlim is a Fule Prediction Software based on Historical Data'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
            ...
            'logo' => [
                'text' => 'Benzlim',
                'url' => 'https://benzlim.tk/'
            ],
            'header' => [
                'title' => 'Benzlim',
                'description' => 'Predict Fuel Prices, <em>Hustle Free</em>.',
                'buttons' => [
                    0 => [
                        'text' => 'Quick Start',
                        'url' => 'documentation',
            ...
            'socialcount' => NULL,
            'copyright' => 'Benzlim 2017. <br> Created by the Benzlim Group.'
        ],
        'streams' => [
            'schemes' => [
                'image' => [
